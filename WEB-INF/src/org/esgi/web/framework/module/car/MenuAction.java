...
public class MenuAction implements IAction {
	...
	public void proceed(IContext context) {
		try {
			...
			context._getResponse().getWriter().println("<li><a href=\"/jwf/car/create\">Create</a></li>");
			context._getResponse().getWriter().println("<li><a href=\"/jwf/car/list\">List</a></li>");
			...
			context._getResponse().getWriter().println("</ul></li>");
			context._getResponse().getWriter().println("<li><a href=\"/jwf/car/search\">Search</a></li>");
			context._getResponse().getWriter().println("</ul></li>");
			context._getResponse().getWriter().println("</ul>");
			context._getResponse().getWriter().println("</ul>");
		} catch (IOException e) {
